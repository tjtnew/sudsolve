...
# sudsolve
`sudsolve` is a small personal project that I've used to get my head around both
C code and how to use it with `R`.  It provides a single user facing function,
`solveGameQuick`, that will solve any standard (9 by 9) sudoku puzzle.  
...
```
## Overview
The solver works in two stages.  Firstly, humanesque[^1] methods are employed to 
